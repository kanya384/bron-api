...
func request_Tables_ReadTablesOfProject_0(ctx context.Context, marshaler runtime.Marshaler, client TablesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReadTablesOfProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ReadTablesOfProject(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Tables_ReadTablesOfProject_0(ctx context.Context, marshaler runtime.Marshaler, server TablesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReadTablesOfProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ReadTablesOfProject(ctx, &protoReq)
	return msg, metadata, err
...
func request_Tables_ReadPanoramasOfProject_0(ctx context.Context, marshaler runtime.Marshaler, client TablesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReadPanoramasOfProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ReadPanoramasOfProject(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Tables_ReadPanoramasOfProject_0(ctx context.Context, marshaler runtime.Marshaler, server TablesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReadPanoramasOfProjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ReadPanoramasOfProject(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTablesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TablesServer) error {
	...
	mux.Handle("GET", pattern_Tables_ReadTablesOfProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/grpc.Tables/ReadTablesOfProject", runtime.WithHTTPPathPattern("/api/table/{projectId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Tables_ReadTablesOfProject_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Tables_ReadTablesOfProject_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Tables_ReadPanoramasOfProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/grpc.Tables/ReadPanoramasOfProject", runtime.WithHTTPPathPattern("/api/panorama/project/{projectId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Tables_ReadPanoramasOfProject_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Tables_ReadPanoramasOfProject_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTablesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TablesClient) error {
	...
	mux.Handle("GET", pattern_Tables_ReadTablesOfProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/grpc.Tables/ReadTablesOfProject", runtime.WithHTTPPathPattern("/api/table/{projectId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Tables_ReadTablesOfProject_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Tables_ReadPanoramasOfProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/grpc.Tables/ReadPanoramasOfProject", runtime.WithHTTPPathPattern("/api/panorama/project/{projectId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Tables_ReadPanoramasOfProject_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Tables_ReadTablesOfProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "table", "projectId"}, ""))
	...
	pattern_Tables_ReadPanoramasOfProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "panorama", "project", "projectId"}, ""))
...
var (
	...
	forward_Tables_ReadTablesOfProject_0 = runtime.ForwardResponseMessage
	...
	forward_Tables_ReadPanoramasOfProject_0 = runtime.ForwardResponseMessage
